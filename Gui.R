...
shinyUI(fluidPage(
    ...
    sidebarLayout(
      sidebarPanel(
        ...
        numericInput('dis', 'Distance (in miles):', 100, min = 1, max = 5000),
        numericInput('cost', 'Gasoline Price (per gallon):', 2.41, min = 1, max = 5, step=0.02),
        numericInput('gas', 'Maximum expenditure on gasoline:', 50, min=1, max=1000),
        checkboxGroupInput('cyl', 'Number of cylinders:', c("Four"=4, "Six"=6, "Eight"=8), selected = c(4,6,8)),
        sliderInput('disp', 'Displacement', min=70, max=480, value=c(240,480), step=10),
